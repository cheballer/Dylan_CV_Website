...
function Counter({ value, suffix = '' }) {
  ...
  useEffect(() => {
    if (inView) animate(count, value, { duration: 1.6, ease: [0.16, 1, 0.3, 1] });
  }, [inView, count, value]);
  ...
  return (
    <section id="about" className="section-pad" style={{ borderTop: '1px solid var(--border)' }}>
      ...
      >
        ...
        {/* ── Oversized statement — CHK-inspired, bleeds to edge ──────── */}
          ...
          {[
            ...
            >
              <p style={{
                ...
                lineHeight: 1, letterSpacing: '-0.04em', color: 'var(--text)',
              }}>
          ...
          >
            <motion.div variants={stagger} className="lg:col-span-7" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              {[
                ...
                <motion.p key={i} variants={up} style={{ color: 'var(--text-2)', fontSize: 'var(--fs-md)', lineHeight: 1.75 }}>
                  {para}
                </motion.p>
              ))}
            </motion.div>
              ...
              >
                {[
                  ...
                  <motion.div
                    ...
                    style={{ background: 'var(--bg)', padding: '1.1rem' }}
                  >
